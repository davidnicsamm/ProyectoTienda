...
import com.atiempo.operaciones.Comestible;
import com.atiempo.operaciones.Identificador;
import com.atiempo.operaciones.TipoAplicacion;
import com.atiempo.operaciones.TipoEnvase;
import com.atiempo.operaciones.TipoProducto;
import com.atiempo.tienda.Bebida;
import com.atiempo.tienda.Envasado;
import com.atiempo.tienda.Limpieza;
import com.atiempo.tienda.Producto;
import com.atiempo.tienda.Tienda;
import com.atiempo.Scripts.Scripts;
...
public class App {
	...
	public static void main(String[] args) {
		...
		cargarProductos(TipoProducto.Bebida, "src/com/atiempo/extras/Bebidas.csv");
		cargarProductos(TipoProducto.Envasado, "src/com/atiempo/extras/Envasados.csv");
		cargarProductos(TipoProducto.Limpieza, "src/com/atiempo/extras/Limpieza.csv");

		do {
			System.out
					.println("**************************************************************************************");
			System.out
					.println("***************************  Sistema gestión de stock ********************************");
